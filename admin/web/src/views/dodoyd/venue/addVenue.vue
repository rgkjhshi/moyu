    ...
    <el-card header="添加场馆">
      <el-form ref="venueForm" :model="venueForm" :rules="rules" label-width="100px">
        <el-form-item label="场馆名称" prop="venueName">
          <el-col :span="8">
            <el-input v-model="venueForm.venueName" placeholder="请输入场馆名称" maxlength="30" />
          </el-col>
        </el-form-item>
        ...
        <el-form-item>
          <el-col :span="4">
            <el-button type="primary" style="width: 100%" @click="handleAddVenue()">添加</el-button>
          </el-col>
        </el-form-item>
      </el-form>
    </el-card>
...
<script>
import { addVenue } from '@/api/dodoyd'
...
export default {
  ...
  computed: {
    ...
    clockList() {
      const clockList = []
      const start = this.openTimeRange.at(0)
      const end = this.openTimeRange.at(1)

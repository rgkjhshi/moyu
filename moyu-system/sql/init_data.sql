...
-- 功能权限组
insert into moyu.sys_group (id, name, code, org_code, org_name, data_scope, scope_set, sort_num, status, ext_json, remark, delete_flag, create_time, create_by, update_time, update_by)
...
values  (2001, '0', '系统模块', 'sys_module', 1, '/sysModule', '', 'appstore-add-outlined', '', 1, null, 'sys_module', 1, 0, null, '', 0, null, null, '2025-02-19 22:22:35', null),
        ...
        (2014, 'dir_sys_org', '岗位管理', 'menu_sys_position', 3, '/sys/position', 'sys/position/index', 'team-outlined', '', 1, null, 'sys_module', 9, 0, null, null, 0, '2025-03-05 20:03:03', 'superAdmin', '2025-03-05 20:03:03', 'superAdmin'),
        (2015, 'dir_sys_perm', '功能权限', 'menu_sys_group', 3, '/sys/group', 'sys/group/index', 'apartment-outlined', '', 1, null, 'sys_module', 7, 0, null, '', 0, null, null, '2025-03-03 16:44:30', 'superAdmin'),
        (2016, 'dir_sys_perm', '数据权限', 'menu_sys_scope', 3, '/sys/scope', 'sys/scope/index', 'database-outlined', '', 1, null, 'sys_module', 8, 0, null, null, 0, '2025-02-28 19:08:54', 'superAdmin', '2025-03-03 16:44:37', 'superAdmin'),
...
values  (1, 'superAdmin', 'superAdmin', 1, 0, null, null, null, null),
        ...
        (4, 'superAdmin', 'menu_sys_position', 2, 0, '2025-03-05 20:12:30', 'superAdmin', '2025-03-05 20:12:30', 'superAdmin'),
        (5, 'superAdmin', 'menu_sys_group', 2, 0, '2025-03-05 20:12:30', 'superAdmin', '2025-03-05 20:12:30', 'superAdmin'),
        (6, 'superAdmin', 'menu_sys_scope', 2, 0, '2025-03-05 20:12:30', 'superAdmin', '2025-03-05 20:12:30', 'superAdmin'),
        (7, 'superAdmin', 'menu_sys_role', 2, 0, '2025-03-05 20:12:30', 'superAdmin', '2025-03-05 20:12:30', 'superAdmin'),
